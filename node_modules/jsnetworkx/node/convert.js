...
function toNetworkxGraph(data, optCreateUsing) {
  var optMultigraphInput = arguments[2] === undefined ? false : arguments[2];
  ...
  G.addNodesFrom(_regeneratorRuntime.mark(function callee$1$0() {
    ...
    return _regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.t77 = _regeneratorRuntime.keys(d);

        case 1:
          if ((context$2$0.t78 = context$2$0.t77()).done) {
            context$2$0.next = 7;
            break;
          }

          n = context$2$0.t78.value;
          context$2$0.next = 5;
          return isNaN(n) ? n : +n;
...
function fromDictOfDicts(d, optCreateUsing) {
  ...
  G.addNodesFrom(_regeneratorRuntime.mark(function callee$1$0() {
    ...
    return _regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.t79 = _regeneratorRuntime.keys(d);

        case 1:
          if ((context$2$0.t80 = context$2$0.t79()).done) {
            context$2$0.next = 7;
            break;
          }

          n = context$2$0.t80.value;
          context$2$0.next = 5;
          return isNaN(n) ? n : +n;
