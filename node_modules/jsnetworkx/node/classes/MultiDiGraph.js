  ...
  _createClass(MultiDiGraph, [{
      ...
      return _regeneratorRuntime.wrap(function edgesIter$(context$2$0) {
        ...
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            return context$2$0.delegateYield(yieldEdges(nodesNbrs, optData, optKeys, 'out'), 't50', 3);
      ...
      return _regeneratorRuntime.wrap(function inEdgesIter$(context$2$0) {
        ...
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            return context$2$0.delegateYield(yieldEdges(nodesNbrs, optData, optKeys, 'in'), 't51', 3);
    ...
    value: _regeneratorRuntime.mark(function degreeIter(optNbunch, optWeight) {
      ...
      return _regeneratorRuntime.wrap(function degreeIter$(context$2$0) {
        ...
        while (1) switch (context$2$0.prev = context$2$0.next) {
          ...
          case 25:
            context$2$0.prev = 25;
            context$2$0.t52 = context$2$0['catch'](21);
            _didIteratorError2 = true;
            _iteratorError2 = context$2$0.t52;
          ...
          case 45:
            context$2$0.prev = 45;
            context$2$0.t53 = context$2$0['catch'](41);
            _didIteratorError3 = true;
            _iteratorError3 = context$2$0.t53;
          ...
          case 64:
            context$2$0.prev = 64;
            context$2$0.t54 = context$2$0['catch'](7);
            _didIteratorError = true;
            _iteratorError = context$2$0.t54;
          ...
          case 98:
            context$2$0.prev = 98;
            context$2$0.t55 = context$2$0['catch'](81);
            _didIteratorError4 = true;
            _iteratorError4 = context$2$0.t55;
    ...
    value: _regeneratorRuntime.mark(function inDegreeIter(optNbunch, optWeight) {
      return _regeneratorRuntime.wrap(function inDegreeIter$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            return context$2$0.delegateYield(yieldDegree(this, this.pred, optNbunch, optWeight), 't56', 1);
    ...
    value: _regeneratorRuntime.mark(function outDegreeIter(optNbunch, optWeight) {
      return _regeneratorRuntime.wrap(function outDegreeIter$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            return context$2$0.delegateYield(yieldDegree(this, this.succ, optNbunch, optWeight), 't57', 1);
  ...
  return _regeneratorRuntime.wrap(function yieldEdges$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 14:
        ...
        context$1$0.t58 = _regeneratorRuntime.keys(keydict);

      case 19:
        if ((context$1$0.t59 = context$1$0.t58()).done) {
          context$1$0.next = 28;
          break;
        }

        key = context$1$0.t59.value;
      ...
      case 33:
        context$1$0.prev = 33;
        context$1$0.t60 = context$1$0['catch'](12);
        _didIteratorError12 = true;
        _iteratorError12 = context$1$0.t60;
      ...
      case 50:
        context$1$0.prev = 50;
        context$1$0.t61 = context$1$0['catch'](3);
        _didIteratorError11 = true;
        _iteratorError11 = context$1$0.t61;
...
function yieldDegree(graph, edges, nBunch, weight) {
  ...
  return _regeneratorRuntime.wrap(function yieldDegree$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 19:
        context$1$0.prev = 19;
        context$1$0.t62 = context$1$0['catch'](15);
        _didIteratorError15 = true;
        _iteratorError15 = context$1$0.t62;
      ...
      case 38:
        context$1$0.prev = 38;
        context$1$0.t63 = context$1$0['catch'](5);
        _didIteratorError14 = true;
        _iteratorError14 = context$1$0.t63;
      ...
      case 68:
        context$1$0.prev = 68;
        context$1$0.t64 = context$1$0['catch'](55);
        _didIteratorError16 = true;
        _iteratorError16 = context$1$0.t64;
